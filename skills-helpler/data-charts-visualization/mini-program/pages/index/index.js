...
const SPECIFIC_FIELD_LABELS = {
  ...
  radar: {
    ...
    axisNameColor: "维度名颜色",
    axisNameBold: "维度名加粗",
    radarAreaLineGroup: "数据面与轮廓",
    areaOpacity: "面积透明度",
    lineStyleType: "线条样式",
    lineWidth: "线条宽度",
    radarPointLabelGroup: "拐点与标签",
    showSymbol: "显示拐点",
    symbol: "拐点形状",
    symbolSize: "拐点大小",
    showLabel: "显示标签",
...
const SPECIFIC_SECTION_HELP = {
  ...
  radar: {
    radarStructureGroup: "控制雷达图形状和分割段数。",
    radarGridLinesGroup: "控制分割线和轴线样式。",
    radarAxisNameGroup: "控制维度名文字样式。",
    radarAreaLineGroup: "控制面积填充和轮廓线样式。",
    radarPointLabelGroup: "控制拐点显示和数据标签样式。"
  },
  funnel: {
