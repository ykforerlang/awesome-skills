(function (root, factory) {
  ...
  const DEFAULT_TITLE = {
    ...
    subtext: "Generated by config helper",
  };
  ...
  const DEFAULT_DATA_BY_CHART = {
    ...
    dualAxis: {
      ...
      series: [
        { name: "Sales", yAxisIndex: 0, data: [320, 332, 301, 334, 390, 330] },
        { name: "Rate", yAxisIndex: 1, data: [10, 12, 9, 14, 18, 16] },
        { name: "Orders", yAxisIndex: 0, data: [210, 226, 198, 245, 278, 256] },
        { name: "Conversion", yAxisIndex: 1, data: [7, 8, 7, 9, 11, 10] },
        { name: "Visits", yAxisIndex: 0, data: [420, 448, 430, 476, 512, 498] },
        { name: "Refund Rate", yAxisIndex: 1, data: [3, 4, 3, 5, 4, 4] },
        { name: "Leads", yAxisIndex: 0, data: [132, 144, 138, 152, 168, 174] },
        { name: "CTR", yAxisIndex: 1, data: [16, 18, 17, 19, 22, 21] },
      ],
    },
    scatter: {
      title: DEFAULT_TITLE,
