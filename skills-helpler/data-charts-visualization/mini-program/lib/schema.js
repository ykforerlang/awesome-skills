  ...
  zh: {
    ...
    dualAxis: {
      ...
      fieldHelp: {
        ...
        rightAxisGroup: "控制右侧数值轴的字号、颜色、刻度和轴线样式。",
        rightBarGroup: "控制右侧系列在柱状形态下的标签、配色和描边样式。",
...
const CHART_DEFINITIONS = {
  ...
  dualAxis: {
    ...
    tags: ["bar/line mix", "secondary axis", "dataset + encode"],
      ...
      { id: "leftAxisScale", label: "Scale Left Axis To Data", type: "checkbox", default: false },
      ...
      { id: "rightAxisScale", label: "Scale Right Axis To Data", type: "checkbox", default: false },
  ...
  radar: {
    ...
    fields: [
      ...
      { id: "radarAxisNameGroup", label: "Axis Names", type: "group", help: "Control radar axis name typography." },
      ...
      { id: "radarAreaLineGroup", label: "Area And Outline", type: "group", help: "Control radar area fill and outline style." },
      ...
      { id: "radarPointLabelGroup", label: "Points And Labels", type: "group", help: "Control radar symbols and value labels." },
      { id: "showSymbol", label: "Show Symbols", type: "checkbox", default: true },
      {
        id: "symbol",
        label: "Symbol",
